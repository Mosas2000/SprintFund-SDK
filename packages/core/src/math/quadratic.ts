import { BigIntString, toBigIntString } from '../types/index.js';
 ...
 */
export function calculateVoteCost(weight: BigIntString): BigIntString {
 ...
 */
export function calculateMaxWeight(stake: BigIntString): BigIntString {
 ...
 */
export function calculateRemainingPower(
  maxWeight: BigIntString,
  usedWeight: BigIntString
): BigIntString {
 ...
 */
export function isValidVoteWeight(
  weight: BigIntString,
  stake: BigIntString
): boolean {
 ...
 */
export function getVotingEfficiency(weight: BigIntString): string {
 ...
 */
export function getMaxVotes(stake: BigIntString): number {
  const maxWeight = calculateMaxWeight(stake);
