 ...
 */
export function parseClarityInt(value: string): BigIntString {
 ...
 */
export function parseClarityTuple(
 ...
 */
export function parseClarityValue(value: unknown): unknown {
  ...
  if (typeof value === 'object' && value !== null && !Array.isArray(value)) {
    return parseClarityTuple(value as Record<string, unknown>);
  }
