 ...
 */
export declare const SPRINTFUND_CONTRACT_PRINCIPAL = "SP31PKQVQZVZCK3FM3NH67CGD6G1FMR17VQVS2W5T.sprintfund-core-v3";
/**
 * Contract name
 */
export declare const SPRINTFUND_CONTRACT_NAME = "sprintfund-core-v3";
/**
 * Contract address
 */
export declare const SPRINTFUND_CONTRACT_ADDRESS = "SP31PKQVQZVZCK3FM3NH67CGD6G1FMR17VQVS2W5T";
/**
 ...
 */
export type ClarityType = 'uint' | 'int' | 'bool' | 'principal' | 'buff' | 'optional' | 'list' | 'tuple' | 'response';
/**
